...
import com.luxvelocitas.tinytcx.TrainingCenterDatabase
...
//    val fname = "activity_1966020755.tcx";
    ...
    val tcx: TrainingCenterDatabase = TrainingCenterDatabase.fromXml(xml.documentElement)!!

    println(tcx.Activities[0].Laps[0].Track.Trackpoints[0].Time)
    println(tcx.Activities[0].Laps[0].TriggerMethod)
